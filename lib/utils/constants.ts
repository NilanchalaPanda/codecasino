...
export const GAME_TIME_LIMITS: Record<GameDifficulty, Record<GameType, number>> = {
  [GameDifficulty.EASY]: {
...
export const TIER_REQUIREMENTS: Record<TierLevel, { minPoints: number; maxPoints: number }> = {
